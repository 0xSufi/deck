...
const translations = {
    ...
    es: {
        ...
        mission_title: "Más allá de un Launchpad",
        mission_text: "Noma combina primitivas DeFi como AMMs de liquidez concentrada con conceptos innovadores como liquidez 'indestructible' y tokenomics automatizados. Es una solución llave en mano para el lanzamiento de tokens descentralizados y sin confianza.",
        ...
        problem_founders_text: "El status quo actual de los lanzamientos de tokens está roto, a menudo resultando en rug pulls e incentivos desalineados.",
        problem_founders_list_1_title: "Riesgos de Rug:",
        problem_founders_list_1_text: "La liquidez a menudo es controlada por insiders.",
        ...
        problem_founders_list_3_text: "Pedir prestado contra activos generalmente conlleva riesgo de liquidación.",

        problem_holders_eyebrow: "La Necesidad",
        problem_holders_title: "Una Mejor Manera",
        problem_holders_text: "Inversores y creadores necesitan un entorno sin confianza con protecciones automatizadas.",
        ...
        creators_text: "Los creadores ganan ~1% de la inflación en cada shift. El protocolo recibe un pago idéntico.",
