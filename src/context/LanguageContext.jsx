...
const translations = {
    en: {
        ...
        market_curve_text: "A deterministic price function where early buyers pay less. Noma's 'shift' is equivalent to 'graduation', marking the transition from bootstrapping to a mature, liquid market.",
    ...
    es: {
        ...
        market_curve_text: "Función de precio determinista donde los primeros compradores pagan menos. El 'shift' de Noma equivale a la 'graduación', marcando la transición de bootstrapping a un mercado líquido y maduro.",
