...
const translations = {
    en: {
        ...
        market_curve_text: "A deterministic price function where early buyers pay less. Noma's 'shift' is equivalent to 'graduation', occurring when all initial floor tokens are bought and the anchor position is depleted, signaling healthy token liquidity.",
    ...
    es: {
        ...
        market_curve_text: "Función de precio determinista donde los primeros compradores pagan menos. El 'shift' de Noma es equivalente a la 'graduación', ocurriendo cuando todos los tokens iniciales del piso se compran y la posición ancla se agota, señalando una liquidez de token saludable.",
