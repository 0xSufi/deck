...
const translations = {
    en: {
        ...
        mission_text: "Noma evolves beyond simple token factories. It combines concentrated liquidity AMMs with 'unruggable' mechanics to create a turn-key solution for sustainable, trust-less token economies.",
        ...
        problem_founders_title: "The Liquidity Trap",
        problem_founders_text: "Current permissionless platforms foster a 'Player vs Player' (PVP) environment. Launches are abundant, but sustainability is non-existent.",
        problem_founders_list_1_title: "Rug & Dump Risks:",
        ...
        problem_founders_list_3_text: "Borrowing against volatile assets carries high risk.",
        ...
        noma_token_title: "$NOMA Utility",
        noma_token_text: "Holding $NOMA gives access to the success of the entire ecosystem.",
    ...
    es: {
        ...
        mission_text: "Noma evoluciona más allá de simples fábricas de tokens. Combina AMMs de liquidez concentrada con mecánica 'indestructible' para crear soluciones llave en mano para economías de tokens sostenibles.",
        ...
        problem_founders_title: "La Trampa de Liquidez",
        problem_founders_text: "Las plataformas actuales fomentan un entorno 'Jugador contra Jugador' (PVP). Los lanzamientos son abundantes, pero la sostenibilidad es inexistente.",
        problem_founders_list_1_title: "Riesgos de Rug & Dump:",
        problem_founders_list_1_text: "La liquidez a menudo se retira o se vende a minoristas.",
        problem_founders_list_2_title: "Oferta Estática:",
        problem_founders_list_2_text: "Los tokens tradicionales no se adaptan a las condiciones del mercado.",
        problem_founders_list_3_title: "Riesgo de Liquidación:",
        problem_founders_list_3_text: "Pedir prestado contra activos volátiles conlleva alto riesgo.",
        ...
        solution_eyebrow: "Propuesta de Valor",
        solution_title: "Inherentemente Indestructible",
        solution_text: "Las reglas codificadas no permiten acuñar de la nada. Cada cambio de oferta es parte de la estrategia de creación de mercado.",
        solution_card_1_title: "Flujo de Ingresos",
        solution_card_1_text: "El protocolo gana de tarifas y reequilibrio, canalizando valor a los holders.",
        solution_card_2_title: "Crecimiento Perpetuo",
        solution_card_2_text: "El precio base aumenta perpetuamente como resultado de la actividad comercial.",
        solution_card_3_title: "Préstamos Auto-pagables",
        solution_card_3_text: "Las ganancias del protocolo pagan los préstamos cuando el LTV es alto.",
        solution_card_4_title: "Sin Liquidación",
        solution_card_4_text: "El precio base solo sube; el valor colateral está seguro.",
        ...
        noma_token_title: "Utilidad de $NOMA",
        noma_token_text: "Mantener $NOMA da acceso al éxito de todo el ecosistema.",
